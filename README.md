...
- 💻 **PaperBag** – A simplified Java-esque language made for Wrench and Bukkit plugins.
- 🤖 **Discord Bots** – TwitchAnnouncer, MemberMessenger, and more.
...
- 💻 **Last seen coding** in *Java*, editing `NametagManager.java` (Project: PlaceholderNametags) - 30 minutes ago

*Last updated: 11-07-2025 15:33:24*
<!-- END_NOW_PLAYING -->
